...
/** The Google Cloud Platform Text-To-Speech (TTS) v1/voices API endpoint. */
export const voices = {
  /** Returns a list of the voices supported for speech synthesis, excluding
   * any AutoML user-trained custom voices that can only be unlocked by
   * contacting the GCP sales team and signing a contract.
